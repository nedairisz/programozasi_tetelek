...
szamlalo: int = szovegkezeles.feladatA("Indul és a tyúk aludni - árvíztűrő tükörfúrógép")
print(f"A szóközök száma: {szamlalo}")

ujszoveg: str = szovegkezeles.feladatB("Indulésatyúkaludni-árvíztűrőtükörfúrógép")
print(ujszoveg)

szovegkezeles.feladatC("Indulésatyúkaludni-árvíztűrőtükörfúrógép")
